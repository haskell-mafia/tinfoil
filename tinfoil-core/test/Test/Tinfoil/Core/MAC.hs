...
module Test.Tinfoil.Core.MAC where
...
prop_hmacSHA256_key_mismatch :: UniquePair SymmetricKey -> ByteString -> Property
prop_hmacSHA256_key_mismatch (UniquePair k1 k2) msg =
  let h1 = hmacSHA256 k1 msg
      h2 = hmacSHA256 k2 msg in
  (h1 == h2) === False

prop_hmacSHA256_msg_mismatch :: SymmetricKey -> UniquePair ByteString -> Property
prop_hmacSHA256_msg_mismatch k (UniquePair msg1 msg2) =
  let h1 = hmacSHA256 k msg1
      h2 = hmacSHA256 k msg2 in
  (h1 == h2) === False

prop_hmacSHA256_reftrans :: SymmetricKey -> ByteString -> Property
