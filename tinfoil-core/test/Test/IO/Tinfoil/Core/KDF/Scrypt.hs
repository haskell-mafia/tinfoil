...
module Test.IO.Tinfoil.Core.KDF.Scrypt where
...
import           Test.Tinfoil.Core.KDF.Scrypt.TestVectors

import           Tinfoil.Core.Data (Credential(..), Verified(..))
import           Tinfoil.Core.Data (NeedsRehash(..))
